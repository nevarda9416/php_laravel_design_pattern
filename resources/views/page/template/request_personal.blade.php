...
@section('content')
    <div class="container">
        ...
        <p class="font14" style="max-width:800px; margin:auto; text-align:center;">Khi khách hàng cá nhân có nhu cầu báo giá, đặt hàng, quý khách vui lòng gửi yêu cầu tới phòng kinh doanh của Phúc Anh. Với kinh nghiệm hơn 20 năm phục vụ, NIIT-ICT sẽ nỗ lực hết mình để làm hài lòng quý khách hàng!</p>
        <br>
        <form method="post" action="/upload/individual.php" enctype="multipart/form-data" onsubmit="return check_field();" style="width: 600px;margin: auto;border: solid 1px #ddd;padding: 10px;">
